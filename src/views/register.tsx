...
import { RegisterValues } from "../interfaces/user.interface";
...
const RegisterView = () => {
  ...
  const createUser = useAuthStore((state: any) => state.createUser)
  ...
  const onSubmitSignupForm = async (values: RegisterValues) => {
    setLoading(true);
                  ...
                  ({
                    ...
                    <Form className="mb-4 p-24" >
                      ...
                      <div className="flex justify-center">
                        <button type="submit" className="px-12 py-4 w-96 mt-10 text-white bg-blue-600 rounded-lg hover:bg-blue-900">
                          Create account
                        </button>
                      </div>
                    </Form>
